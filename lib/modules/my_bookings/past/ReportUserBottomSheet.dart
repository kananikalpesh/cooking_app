...
class ReportUserBottomSheet{
  ...
  Future<dynamic> showReportUserBookingSheet(BuildContext context, int reportId, PastBookingsBloc pastBookingsBloc, int lessonBookingId) async {
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(((AppData.user.role == AppConstants.ROLE_USER) ? AppStrings.reportCookLabel : AppStrings.reportUserLabel),
                      ...
                      _BottomWidget(reportId, pastBookingsBloc, lessonBookingId),
                    ],
                  ),
                ),),
            ),
...
class _BottomWidget extends StatefulWidget {
  ...
  _BottomWidget(this.reportId, this.pastBookingsBloc, this.lessonBookingId);
...
class _BottomWidgetState extends State<_BottomWidget> {
  ...
  void initState() {
    ...
    widget.pastBookingsBloc.obsReportRequest.stream.listen((result) {
          ...
          children: [
            Container(
              child: TextFormField(
                ...
                validator: ValidationUtils.getEmptyValidator(context, AppStrings.enterComment),
              ),
            ),
            Align(
            ...
            ValueListenableProvider<bool>.value(
              value: widget.pastBookingsBloc.isReportLoading,
              child: Consumer<bool>(
            ...
            child: ElevatedButton(
              onPressed: () {
                if (_formKey.currentState.validate()) {
                  ...
                  widget.pastBookingsBloc.event.add(EventModel(PastBookingsBloc.REPORT_USER_OR_COOK, data: data));
                }
              },
              child: Text(AppStrings.reportButtonTitle),
            ),
          ),
        ],
      ),
