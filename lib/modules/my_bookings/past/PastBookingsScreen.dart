...
class PastBookingsScreen extends StatefulWidget{
  ...
  @override
  State<StatefulWidget> createState() => PastBookingsScreenState();

}

class PastBookingsScreenState extends State<PastBookingsScreen>{

  PastBookingsBloc _bloc;
        ...
        ListView.builder(
            ...
            itemBuilder: (context, index) {
              if (index == (valueListCount)) {
                ...
                return BookingItemWidget(index, _bloc.bookingsList[index], isPastBooking: true,
                  pastBookingsBloc: _bloc);
              }
            }),
      ],
  ...
  _loadNewData() {
    ...
    _bloc.event.add(EventModel(PastBookingsBloc.GET_MY_BOOKINGS));
  }
