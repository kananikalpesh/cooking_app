...
class ApproveBookingBottomSheet{

   Future<dynamic> showApproveBookingSheet(BuildContext context, int lessonRequestId, MyRequestBloc myRequestBloc) async {
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(AppStrings.approveBookingRequest, style:Theme.of(context).textTheme.subtitle1.apply(fontWeightDelta: -1, fontSizeDelta: 4,),),
...
class _BottomWidgetState extends State<_BottomWidget> {
  ...
  void initState() {
    ...
    widget.myRequestBloc.obsApproveRequest.stream.listen((result) {
        ...
        child: Column(
          ...
          children: [
            ...
            ValueListenableProvider<bool>.value(
              value: widget.myRequestBloc.isApproveRequestLoading,
              child: Consumer<bool>(
              ...
              onPressed: () {
                if (_formKey.currentState.validate()) {
                  ...
                  Map<String, dynamic> data = <String, dynamic>{
                    "l": widget.lessonRequestId,
                    "n": _reason ?? "",
                  };
                  widget.myRequestBloc.event.add(EventModel(MyRequestBloc.APPROVE_BOOKING_REQUEST, data: data));
                }
              },
              child: Text(AppStrings.approveButtonName),
            ),
          ),
        ],
      ),
