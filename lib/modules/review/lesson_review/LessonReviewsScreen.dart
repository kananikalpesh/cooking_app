...
import 'package:cooking_app/modules/review/lesson_review/LessonReviewsBloc.dart';
...
class LessonReviewsScreen extends StatefulWidget{
  ...
  LessonReviewsScreen(this.lessonId, this.lessonName);

  @override
  State<StatefulWidget> createState() => LessonReviewsScreenState();

}

class LessonReviewsScreenState extends State<LessonReviewsScreen>{

  LessonReviewsBloc _bloc;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("${widget.lessonName} ${AppStrings.reviewsLabel}")),
  ...
  _loadNewData() {
    ...
    _bloc.event.add(EventModel(LessonReviewsBloc.GET_LESSONS_REVIEWS, data: widget.lessonId));
  }
