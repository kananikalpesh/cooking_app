...
class CancelBookingBottomSheet{
  ...
  static Future<dynamic> showCancelBookingSheet(BuildContext context, int lessonRequestId, bool isFromCook) {
            ...
            child: ClipRRect(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text(AppStrings.cancelBooking, style:Theme.of(context).textTheme.subtitle1.apply(fontWeightDelta: -1, fontSizeDelta: 4,),),
                    SizedBox(height: AppDimensions.maxPadding,),
                    _BottomWidget(lessonRequestId, isFromCook),
                  ],
                ),
              ),),
            ),
...
class _BottomWidget extends StatefulWidget {
  ...
  _BottomWidget(this.lessonRequestId, this.isFromCook);
            ...
            child: ElevatedButton(
              onPressed: () {
                if (_formKey.currentState.validate()) {
                  ...
                  _bloc.event.add(EventModel(ActionableWidgetBloc.CANCEL_LESSON_BOOKING_REQUEST, data: data));
                }
              },
