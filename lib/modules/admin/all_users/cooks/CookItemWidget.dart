...
typedef _CookDeleted(bool isDeleted);

class CookItemWidget extends StatefulWidget{

  final UserModel _userModel;
  final _CookDeleted _onAvailabilityDeleted;
  final CookListBloc _bloc;
  final int index;
  CookItemWidget(this.index, this._userModel, this._bloc, this._onAvailabilityDeleted);

  @override
  _CookItemWidgetState createState() => _CookItemWidgetState();
}

class _CookItemWidgetState extends State<CookItemWidget>{
  ...
  void initState() {
    ...
    widget._bloc.obsDeleteCook.listen((result) {
          ...
          child: ListTile(
            onTap: (){
              ...
              Navigator.of(context)
                  ...
                  builder: (context) => OtherCookProfileScreen(cookId: widget._userModel.id,))).then((value) {
                SystemChrome.setEnabledSystemUIOverlays(
                    [SystemUiOverlay.bottom, SystemUiOverlay.top]);
